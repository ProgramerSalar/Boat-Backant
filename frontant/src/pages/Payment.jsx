...
const Payment = () => {
  ...
  // const formattedPrice = price[0] === undefined ? '' : price[0];
  // console.log("formatPrice", formattedPrice)
...
console.log('Total Price:', total_price);
  ...
  // const total_price = price[0] === undefined ? price[1] : price[0]
  // console.log("NewtotalPrice", total_price)
